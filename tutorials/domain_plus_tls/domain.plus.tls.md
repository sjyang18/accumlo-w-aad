...
Add the following variables to your host file, if you don't have. These variables should be set from muchos.properties file and when running 'sync' command of fluo-muchos. Note that we provided the flexibility of turning off TLS at the zookeeper layer. You explictly set enable_zookeeper_tls, only if your Accumulo version has this patch (https://github.com/apache/accumulo/pull/1883).
